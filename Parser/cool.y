...
%{
  ...
  for the location of tokens */
    ...
    */
    ...
    feature: OBJECTID ':' TYPEID ASSIGN expr ';'{$$ = attr($1, $3, $5);}
    		| OBJECTID ':' TYPEID ';' {$$  = attr($1,$3,no_expr());}
    		| OBJECTID '(' formal_list ')' ':' TYPEID '{' expr '}' ';'{$$ = method($1,$3,$6,$8);}
    		| error ';'
    ;
    /* Formal arguments of a function, can be empty */
    formal_list: formal
	    			{
	    				$$ = single_Formals($1);	
	    			}
    ...
    /* Body of a method or featur is made up of expression(s) */
    ...
    parameters:/*empty*/ {$$ = nil_Expressions();}  
    		| expr {$$=single_Expressions($1);}
    		| parameters ',' expr  {$$=append_Expressions($1, single_Expressions($3));}
    ;
    ...
    expr: OBJECTID ASSIGN expr                                          {$$ = assign($1, $3);} 
    	| expr '.' OBJECTID '(' parameters ')'                          {$$ = dispatch($1,$3,$5);}
    	| expr '@' TYPEID '.' OBJECTID '(' parameters ')' 				{$$ = static_dispatch($1,$3,$5,$7);}
    	...
    	| LET OBJECTID ':' TYPEID ASSIGN expr let_list  				{$$ = let($2,$4,$6,$7);}
